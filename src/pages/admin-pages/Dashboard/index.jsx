...
import AdminApprovalCard from "../../../components/admin-components/admin-approval-card";
import AdminCards from "../../../components/admin-components/admin-cards";
import CreditsCard from "../../../components/admin-components/credits-card";
import ProjectSumissionGraph from "../../../components/admin-components/project-sumission-graph";
import RanksCard from "../../../components/admin-components/ranks-card";
import StudentsCard from "../../../components/admin-components/students-card";
...
const Dashboard = () => {
  ...
  // Fetching data for an individual college
  useEffect(() => {
    //fetch Projects
  ...
  return (
    <>
      {display ? (
        <div
          className="flex flex-col w-full m-4 gap-4 "
          style={{ height: "100vh" }}
        >
          <AdminCards
            students={students}
