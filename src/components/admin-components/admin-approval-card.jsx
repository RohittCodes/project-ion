...
const AdminApprovalCard = (props) => {
  ...
  return (
    <div
      className="flex flex-col bg-background-components px-3 py-2 rounded-2xl border-border-secondary border-[1px] animate__animated animate__backInLeft"
      ...
      <div className="w-full">
        ...
        {projects.length > 0 ? (
              ...
              {projects.map((data, index) => (
                <tr key={index}>
                  ...
                  <td className="h-8 w-20 text-center" key="Approved">
                    <button
                      className="bg-green-700 rounded-md border-border-secondary border-[1px] px-1 py-[1px]"
          ...
          <h1
            ...
            className="mt-5"
          >
            There are currently no pending projects requiring approval.
          </h1>
        )}
      </div>
    </div>
